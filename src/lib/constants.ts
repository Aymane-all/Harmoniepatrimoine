...
export const DEPTS: Record<string, string> = {
  ...
  "26": "Drome", "27": "Eure", "28": "Eure-et-Loir",
  "29": "Finistere", "30": "Gard", "31": "Haute-Garonne",
  "32": "Gers", "33": "Gironde", "34": "Herault",
  "35": "Ille-et-Vilaine", "36": "Indre", "37": "Indre-et-Loire",
  "38": "Isere", "39": "Jura", "40": "Landes",
  ...
  "56": "Morbihan", "57": "Moselle", "58": "Nievre",
  ...
  "68": "Haut-Rhin", "69": "Rhone", "70": "Haute-Saone",
  "71": "Saone-et-Loire", "72": "Sarthe", "73": "Savoie",
...
// Departements Ile-de-France (plafonds revenus plus eleves)
export const IDF = ["75", "77", "78", "91", "92", "93", "94", "95"];

// Aides locales par departement (en euros)
export const AIDES_LOCALES: Record<string, number> = {
  "06": 1600, "13": 1500, "31": 1000, "33": 1200,
  "34": 1200, "38": 1000, "59": 1300, "67": 1100, "69": 1400,
};

// Liste des departements pour le select (avec libelles formates)
export const DEPTS_OPTIONS = Object.entries(DEPTS)
  .map(([code, nom]) => ({ code, label: `${code} — ${nom}` }))
